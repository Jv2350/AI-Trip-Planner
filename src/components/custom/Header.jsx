...
import { FcGoogle } from "react-icons/fc";
import { FaHome, FaInfoCircle, FaEnvelope, FaMoon, FaSun, FaBars, FaTimes } from "react-icons/fa";
import axios from 'axios';
  ...
  return (
    <header className={`header ${darkMode ? 'dark-mode' : ''}`}>
      <div className="header-left">
        ...
        {/* Navigation Links - Will be displayed on larger screens and in pop-up on smaller screens */}
        <nav className={`nav-links ${menuOpen ? 'open' : ''}`}>
          ...
          {user && (
            <>
              <a href="/create-trip" className="nav-item">
                <Button variant="outline" className="btn">Create Trip</Button>
              </a>
